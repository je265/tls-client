...
var IosTLSProfile = ClientProfile{
...
var CloudflareBypassProfile = ClientProfile{
	clientHelloId: tls.ClientHelloID{
		Client:  "Chrome_Cloudflare_Bypass",
		Version: "1",
		SpecFactory: func() (tls.ClientHelloSpec, error) {
			return tls.ClientHelloSpec{
				CipherSuites: []uint16{
...
var MinimumTLSProfile = ClientProfile{
	clientHelloId: tls.ClientHelloID{
		Client:  "Minimum_TLS",
		Version: "1",
		SpecFactory: func() (tls.ClientHelloSpec, error) {
...
var CloudflareBypassExtreme = ClientProfile{
	clientHelloId: tls.ClientHelloID{
		Client:  "Chrome_116_CF_Bypass",
		Version: "1",
		SpecFactory: func() (tls.ClientHelloSpec, error) {
			return tls.ClientHelloSpec{
				CipherSuites: []uint16{
				...
				Extensions: []tls.TLSExtension{
					...
					// --- Key Share and Curves (GREASE + real) ---
					&tls.KeyShareExtension{
						KeyShares: []tls.KeyShare{
							{Group: tls.CurveID(0x0a0a)}, // GREASE
							{Group: tls.X25519},
						},
					},
					...
					// --- Optional generic GREASE-like noise ---
					&tls.GenericExtension{Id: 0x2a2a, Data: []byte{}},
				},
			}, nil
		},
	},
	...
	settings: map[http2.SettingID]uint32{
		...
		http2.SettingInitialWindowSize:    6291456, // Chrome-like
